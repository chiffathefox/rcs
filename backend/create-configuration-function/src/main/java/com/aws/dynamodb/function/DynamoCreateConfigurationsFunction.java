...
@Log4j
public class DynamoCreateConfigurationsFunction extends AbstractFunction
  ...
  public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent requestEvent,
    ...
    return constructResponse(daoService.createRobotConfiguration(robotConfiguration));
  }
}
